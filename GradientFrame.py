#The code wasn't written by myself. It was copied from a website
#https://codingshiksha.com/python/python-3-tkinter-gradient-background-color-frame-gui-desktop-app-full-project-for-beginners/
#It is used to create a canvas, which has to look like a gradient for the background
